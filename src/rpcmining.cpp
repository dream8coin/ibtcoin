...
//    Litecoin and modified for IbtCoin.
//
//    Parameters: lookup (int) - How many blocks to look into the past.
//    Returns: Estimated IbtCoin network hash rate (uint64_t)
//
...
// WM - Implementation of getnetworkhashps for IbtCoin
Value getnetworkhashps(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            "getnetworkhashps\n"
            "Returns an estimate of the IbtCoin network hash rate.");
